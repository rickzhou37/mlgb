...
class PEPNet(tf.keras.Model):
    ...
    def call(self, inputs):
        # （batch，fea_num, unit）?
        _, embed_3d_tensor = self.input_fn(inputs) # (batch_size, spare_fea_num + numerical_fea_num, emb_dim)
        print("#PEPNet, embed_3d_tensor shape: ", embed_3d_tensor.shape)
        ...
        #
        print("#PEPNet, g_3d_tensor shape: ", g_3d_tensor.shape)
        print("#PEPNet, ep_3d_tensor shape: ", ep_3d_tensor.shape)
        print("#PEPNet, pp_3d_tensor shape: ", pp_3d_tensor.shape)
